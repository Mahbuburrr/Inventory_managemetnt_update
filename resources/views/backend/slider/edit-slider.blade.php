          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Edit Slider
                  <a href="{{route('sliders.view')}}" class="btn btn-success float-right btn-sm"><i 
                  class="fa fa-list"></i>ALL Slider</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
               ...
               <form action="{{route('sliders.update',$editData->id)}}" method="POST" id="myForm" enctype="multipart/form-data" >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="long_title" id="long_title" value="{{$editData->long_title}}" class="form-control" >
                    ...
                    <div class="form-group col-md-2">
                        <img id="showImage" src="{{(!empty($editData->image)) ? asset('upload/slider_images/'.$editData->image):
