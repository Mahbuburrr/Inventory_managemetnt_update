          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Edit User
                  <a href="{{route('suppliers.view')}}" class="btn btn-success float-right btn-sm"><i 
                  class="fa fa-list"></i>Suppliers List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">

               <form action="{{route('suppliers.update',$editData->id)}}" method="POST" id="myForm" enctype="multipart-data/form" >
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="mobile" value="{{$editData->mobile_no}}"  class="form-control" >
